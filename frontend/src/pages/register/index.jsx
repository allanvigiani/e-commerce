                ...
                <div className="container h-full px-6 py-24">
                    <div
                        ...
                        <div className="mb-12 md:mb-0 md:w-8/12 lg:w-6/12">
                            <Image src="/assets/register/register.svg" alt="Imagem no cadastro do E-commerce" width={800} height={400} />
                        </div>

                        <div className="md:w-8/12 lg:ml-6 lg:w-5/12">
                            <h3 className="mb-8 font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl"><span className="underline underline-offset-3 decoration-8 decoration-blue-400 ">Cadastre-se agora!</span></h3>
                            ...
                            {success && <p className="error bg-green-200 mt-4 text-center rounded">{success}</p>}

                            <div className="mt-4 flex items-center justify-center">
                                <p className="mr-1">Já possui uma conta? Faça o </p>
                                <Link href="/login" className="text-sky-600 text-primary transition duration-150 ease-in-out hover:text-sky-800 focus:text-primary-600 active:text-primary-700">
                                    Login
                                </Link>
                            </div>
