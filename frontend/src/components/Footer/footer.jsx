export default function Footer() {
    return (
        <div className="bg-sky-100 mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 px-4 py-12">
            <div className="flex flex-col items-center justify-center">
                <div>
                    <h2>Logo E-commerce</h2>
                </div>
                <div className="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
                    <p className="hover:text-gray-500 text-base cursor-pointer leading-4 text-gray-800">Sobre nós</p>
                    <p className="hover:text-gray-500 text-base cursor-pointer leading-4 text-gray-800">Entre em contato</p>
                    <p className="hover:text-gray-500 text-base cursor-pointer leading-4 text-gray-800">Termos de serviço</p>
                    <p className="hover:text-gray-500 text-base cursor-pointer leading-4 text-gray-800">Política de privacidade</p>
                </div>
                ...
                <div className="flex items-center mt-6">
                    <p className="text-base leading-4 text-gray-800">
                        2023 - <span className="font-semibold">E-commerce</span>
                    </p>
                    <div className="border-l border-gray-800 pl-2 ml-2">
                        <p className="text-base leading-4 text-gray-800">Todos os direitos reservados.</p>
                    </div>
                </div>
            </div>
        </div>
